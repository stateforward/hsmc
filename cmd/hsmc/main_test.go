...
func TestParseLanguageOtherAliases(t *testing.T) {
	cases := map[string]hsmc.Language{
		...
		"elixir":     hsmc.LanguageElixir,
		"ex":         hsmc.LanguageElixir,
		"exs":        hsmc.LanguageElixir,
		"hsm.ex":     hsmc.LanguageElixir,
		"go":         hsmc.LanguageGo,
...
func TestInferLanguageFromPath(t *testing.T) {
	cases := map[string]hsmc.Language{
		...
		"door.ex":       hsmc.LanguageElixir,
		"door.exs":      hsmc.LanguageElixir,
